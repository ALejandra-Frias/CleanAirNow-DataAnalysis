...
```{r}
#pollution rose
pollutionRose(ad_pr, ws = "ws", wd = "wd", pollutant = "PM2.5", key.footer = "Spring 2021 PM2.5 Plot in Armourdale, KS (ug/m^3)", key.position = "right", breaks = c(0,15,30,45,60,100), grid.line = 5, key = list(labels = c("0-15", "16-30", "31-45", "46-60", "60+")))
```
