...
```{r}
pollutionRose(ad_pr, ws = "ws", wd = "wd", pollutant = "PM2.5", breaks = c(0,5,10,20, 35, 50), auto.text = FALSE, paddle = FALSE, annotate = FALSE, grid.line = 5, key = list(labels = c(">0-5", ">5-10", ">10-20", ">20-35", ">35-50")), key.footer = "Fall 2020 PM2.5 Plot in Armourdale, KS (ug/m^3)", key.position = "bottom", par.settings=list(axis.line=list(col="lightgray")), col = c("#4f4f4f", "#0a7cb9", "#f9be00", "#ff7f2f", "#d7153a"))
```
