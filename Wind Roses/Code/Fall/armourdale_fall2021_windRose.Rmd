...
ad_fall2021$Temperature <- as.numeric(ad_fall2021$Temperature)
ad_fall2021$ws <- as.numeric(ad_fall2021$ws)
ad_fall2021$wd <- as.numeric(ad_fall2021$wd)
```
...
ad_fall2021$Temperature <- celsius.to.fahrenheit(ad_fall2021$Temperature, round = 2)
```
