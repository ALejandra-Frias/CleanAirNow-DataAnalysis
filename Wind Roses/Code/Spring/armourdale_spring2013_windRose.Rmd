...
ad_spring2013$Temperature <- as.numeric(ad_spring2013$Temperature)
ad_spring2013$ws <- as.numeric(ad_spring2013$ws)
ad_spring2013$wd <- as.numeric(ad_spring2013$wd)
```
...
ad_spring2013$Temperature <- celsius.to.fahrenheit(ad_spring2013$Temperature, round = 2)
```
