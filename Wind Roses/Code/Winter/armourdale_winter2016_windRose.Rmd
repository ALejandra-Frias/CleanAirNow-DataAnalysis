...
ad_winter2016$Temperature <- as.numeric(ad_winter2016$Temperature)
ad_winter2016$ws <- as.numeric(ad_winter2016$ws)
ad_winter2016$wd <- as.numeric(ad_winter2016$wd)
```
...
ad_winter2016$Temperature <- celsius.to.fahrenheit(ad_winter2016$Temperature, round = 2)
```
